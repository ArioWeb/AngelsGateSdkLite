                ...
                try {
                    ...
                    if (ObjectORArray.equals("Object")) {
                        ...
                        if (originalRequestJsonObject != null) {
                            ...
                            ModifiedRequestJsonObject.put("Signature", EncodeAlgorithmUtils.computeHash(String.valueOf(Ssalt) + currentYear + Request + Base64Utils.toBase64(originalRequestJsonObject.toString()) + DeviceId + timestamp, String.valueOf(Ssalt)));

                        } else {
                            ModifiedRequestJsonObject.put("Signature", EncodeAlgorithmUtils.computeHash(String.valueOf(Ssalt) + currentYear + Request + Base64Utils.toBase64("") + DeviceId+ timestamp, String.valueOf(Ssalt) ));
                        ...
                        if (originalRequestJsonArray != null) {
                            ...
                            ModifiedRequestJsonObject.put("Signature", EncodeAlgorithmUtils.computeHash(String.valueOf(Ssalt) + currentYear + Request + Base64Utils.toBase64(originalRequestJsonArray.toString()) + DeviceId+ timestamp, String.valueOf(Ssalt) ));
